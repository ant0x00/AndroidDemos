...
//	final static String[] lunarHoliday = new String[] { "0101 春节", "0115 元宵", "0505 端午", "0707 情人", "0715 中元", "0815 中秋", "0909 重阳", "1208 腊八", "1224 小年", "0100 除夕" };
	final static String[] lunarHoliday = new String[] { "0101 春节", "0115 元宵节", "0505 端午节","0707 七夕",
			"0715 中元节","0815 中秋节", "0909 重阳节","1208 腊八节","1224 小年","1230 除夕" };

	// 公历部分节假日
//	final static String[] solarHoliday = new String[] { //
//	"0214 情人", "0308 妇女", "0312 植树", "0315 消费者权益日", "0401 愚人", "0501 劳动", "0504 青年", //
...
//			"1001 国庆", "1006 老人", "1024 联合国日", "1112 孙中山诞辰纪念", "1220 澳门回归纪念", "1225 圣诞", "1226 毛泽东诞辰纪念" };
	...
	final static String[] solarHoliday = new String[] {
			"0101 元旦","0214 情人节","0308 妇女节", "0312 植树节","0401 愚人节","0405 清明节","0501 劳动节","0504 青年节","0512 护士节",
			"0601 儿童节","0701 建党节","0801 建军节","0808 父亲节",  "0910 教师节",
			"1001 国庆节", "1111 光棍节", "1224 平安夜", "1225 圣诞节"};
	...
	public String getLunarDate(int year_log, int month_log, int day_log, boolean isday) {
		...
		if (!isday) {
			...
			for (int i = 0; i < lunarHoliday.length; i++) {//阴历日期在前，重复只显示阴历
				// 返回农历节假日名称
			...
			for (int i = 0; i < solarHoliday.length; i++) {//如果阳历节日和阴历重叠，先显示阳历需要放前面调换位置
				// 返回公历节假日名称
